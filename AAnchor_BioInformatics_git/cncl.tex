...
As the number of released high resolution maps grows \cite[]{Lawson2016EMDataBank3DEM}, the detection accuracy will rise. 
Applying post processing techniques such as Linear Regression \cite[]{Naseem2010LinearRecognition} and SVM \cite[]{Girshick2014} may potentially decrease the number of false detections.
Hopefully, with the accumulation of a sufficiently large number of experimental maps the classification of all voxels in a map to the different amino acids will be solvable using the Fully Convolutional CNN \cite[]{Long2015FullySegmentation} technique.
